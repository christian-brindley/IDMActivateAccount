 ...
 * @since AM 5.5.0
 */
public class idmActivateAuthNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(idmActivateAuthNodePlugin.currentVersion, 
				Collections.singletonList(idmActivateAuthNode.class));
	}
	...
	public String getPluginVersion() {
		return idmActivateAuthNodePlugin.currentVersion;
	}
}
